...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,BluetoothGattCharacteristic characteristic) {
            ...
            //数据
         /*   Log.i("mafuhua", "返回读出的值"+bytes);
            Log.d("mafuhua", binary(bytes, 16)+"========");*/
    ...
    private void broadcastUpdate(final String action,
       ...
       /* if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            if ((flag & 0x01) != 0) {
                ...
                Log.d("mafuhua", "Heart rate format UINT16.");
            } else {
                format = BluetoothGattCharacteristic.FORMAT_UINT8;
                Log.d("mafuhua", "Heart rate format UINT8.");
            }
      ...
      //  Log.d("mafuhua",bytes.toString()+"-----------------");

               // Log.d("mafuhua",binary(bytes, 2)+"*******");
            ...
            if (data != null && data.length > 0) {
                ...
                Log.d("mafuhua","----------"+stringBuilder.toString());
            }
       /* }*/
        sendBroadcast(intent);
    }
